...
public class TelaEditarReserva extends javax.swing.JFrame {
     ...
     *
     */
    public TelaEditarReserva(Reserva reservaSelecionada) {
        initComponents();
        this.reserva = reservaSelecionada;
        preencheDados();
    }
    ...
    public void preencheDados() {
        ...
        txtIdHospede.setText(String.valueOf(reserva.getHospedeId()));
        txtIdQuarto.setText(String.valueOf(reserva.getQuartoId()));
        txtCheckin.setText(reserva.getDataCheckin().format(formatter));
        txtPrevCheckout.setText(reserva.getDataPrevCheckout().format(formatter));
        if (reserva.getDataCheckout() != null) {
            txtCheckout.setText(reserva.getDataCheckout().format(formatter));
        } else {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            reserva.setHospedeId(Integer.parseInt(txtIdHospede.getText()));
            reserva.setQuartoId(Integer.parseInt(txtIdQuarto.getText()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaEditarReserva(reserva).setVisible(true);
            }
        });
    }
